...
func _load_tracks() -> void:
	tracks["title"] = _load_mp3("res://assets/audio/bgm/Pixel Dust Rodeo.mp3")
	tracks["select"] = _load_mp3("res://assets/audio/bgm/Silver Cartridge Highway.mp3")
	tracks["battle"] = _load_mp3("res://assets/audio/bgm/Silver Cartridge Highway2.mp3")
